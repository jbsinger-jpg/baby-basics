...
export default function MilestonePage() {
    ...
    return (
        <VStack>
            ...
            />
            <Input
                value={selectedMotorMilestones}
                isReadOnly
                size='sm'
            />
            <Input
                value={selectedCommunicationMilestones}
                isReadOnly
                size='sm'
            />
            <Input
                value={selectedFeedingMilestones}
                isReadOnly
                size='sm'
            />
            <Input
                value={selectedSensoryMilestones}
                isReadOnly
                size='sm'
            />
            <Input
                value={selectedHyperLinks}
                isReadOnly
                size='sm'
            />
        </VStack>
