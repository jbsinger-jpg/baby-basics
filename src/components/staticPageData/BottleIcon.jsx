...
export default function BottleIcon() {
    return (
        <Icon viewBox="0 0 800 800" boxSize="25" color="white" fill="white">
            <svg fill="#FFFFFF" height="800px" width="800px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"
                viewBox="0 0 510.993 510.993" space="preserve">
                <g>
